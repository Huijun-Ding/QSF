        ...
        <div class="jumbotron">
          <div class="container">
            ...
            <div class="flex-parent d-flex justify-content-md-between bd-highlight mb-2">
              <h1>LES PROJETS ASSOCIATIFS PAR CATEGORIE </h1>
            ...
            <div class="col-10">
              ...
              if (isset($_POST['categorie'])) {
                ...
                $query = "select p.TitreP, p.DescriptionP, c.PhotoC, p.DateButoireP from projet p, categories c where p.CodeC = c.CodeC and p.CodeC = {$cate} order by p.CodeP DESC";
                ...
                while ($ligne = mysqli_fetch_array($result)) {                      /* Afficher tous les besoins par l'ordre chronologique */
                    ...
                    echo ('<h8 class="card-text">'.$ligne["DescriptionP"].'</h8>');
                    echo ('<p class="card-text">Avant: '.$ligne["DateButoireP"].'</p>');
