        ...
        <div class="jumbotron">
          <div class="container">
              ...
              <form action="talentnon.fonction.php" method="GET">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="raison_non_talent" id="talent_raison2" value="Je ne suis pas libre jusqu'à ">
                  <label class="form-check-label" for="talent_raison2">
                    Je ne suis pas libre jusqu'à 
                  </label>
                  <input type="date" name="datedispo" class="form-control col-md-4" id="talent_raison3" maxlength="10">
                </div><br>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="raison_non_talent" id="talent_raison4" value="Autre: ">
                  <label class="form-check-label" for="talent_raison4">
                    Autre
                  </label>
                </div>
