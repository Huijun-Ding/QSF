...
//Envoyer un mail pour informer cette personne
        ...
        $sql = "SELECT u.Email FROM utilisateurs u, proposer p WHERE u.CodeU = p.CodeU and CodeT = $CodeT";
...
</span><p style="padding: 0; margin: 0;">Votre talent a été supprimé par l\'administrateur</p><span class="mso-font-fix-tahoma">
