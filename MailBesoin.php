          ...
          <div class="container">
              ...
              <form action="besoin.email.php" method="GET">
                <div class="form-group row">
                    <label for="destinataire" class="col-sm-2 col-form-label"><strong>De</strong></label>
                  <div class="col-sm-10">
                    <input type="text" readonly class="form-control-plaintext" id="destinataire" value="<?php require_once('Fonctions.php'); echo $_SESSION['email']; ?>" disabled >
                  </div>
                </div>
                        ...
                        //requête prendre titre de besoin
                         ...
                         if (mysqli_num_rows($result)>0) {       
                              while ($besoin = mysqli_fetch_array($result)) {         
                                ...
                                <td style="padding-top:3px;padding-right:20px;padding-bottom:3px;padding-left:20px">
                                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-top:2px solid #4f772d">
                                <tr>
